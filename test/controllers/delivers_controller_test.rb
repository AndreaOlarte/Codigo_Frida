...
class DeliversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deliver" do
    assert_difference('Deliver.count') do
      post delivers_url, params: { deliver: { file: @deliver.file, grade: @deliver.grade, id_module: @deliver.id_module, id_team: @deliver.id_team } }
    end
  ...
  test "should update deliver" do
    patch deliver_url(@deliver), params: { deliver: { file: @deliver.file, grade: @deliver.grade, id_module: @deliver.id_module, id_team: @deliver.id_team } }
