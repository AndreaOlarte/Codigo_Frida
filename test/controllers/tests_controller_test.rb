...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { id_module: @test.id_module, test_link: @test.test_link } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { id_module: @test.id_module, test_link: @test.test_link } }
